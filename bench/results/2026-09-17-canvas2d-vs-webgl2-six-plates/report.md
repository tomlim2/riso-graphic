...
| --- | --- | --- | --- | --- |
| RIPPLE | 27.73 ms · 6장 | 1.29 ms · 96장 | 3.7 ms | 21× |
| MOON | 96.52 ms · 6장 | 1.78 ms · 96장 | 4.1 ms | 54× |
| GARDEN | 34.88 ms · 6장 | 1.41 ms · 96장 | 4.1 ms | 25× |
| JELLY | 122.62 ms · 6장 | 3.83 ms · 96장 | 5.1 ms | 32× |
| CELL | 72.1 ms · 6장 | 1.89 ms · 96장 | 4 ms | 38× |
| CHLORO | 71.2 ms · 6장 | 2.47 ms · 96장 | 4.1 ms | 29× |

콘택트 시트 한 벌. MOON을 배색 아홉 벌로, 1/3 크기로 찍었다.

|  | 옛 | 새 |
| --- | --- | --- |
| 평균 | 125.85 ms | 14.7 ms |
| 잰 횟수 | 2 | 5 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| RIPPLE | 0.04 ms | 0.07 ms | 1.07 ms | 0.41 ms | 0.61 ms | 1.14 ms | 0.1 ms |
| MOON | 0.17 ms | 0.22 ms | 1.53 ms | 0.6 ms | 0.92 ms | 1.75 ms | 0.27 ms |
| GARDEN | 0.09 ms | 0.11 ms | 1.19 ms | 0.47 ms | 0.68 ms | 1.3 ms | 0.14 ms |
| JELLY | 1.31 ms | 1.39 ms | 2.16 ms | 0.71 ms | 1.48 ms | 3.56 ms | 0.3 ms |
| CELL | 0.29 ms | 0.34 ms | 1.51 ms | 0.59 ms | 0.88 ms | 1.85 ms | 0.26 ms |
| CHLORO | 0.82 ms | 0.88 ms | 1.71 ms | 0.65 ms | 1.06 ms | 2.59 ms | 0.25 ms |
...
| CHLORO | 203.9 / 221.0 / 210.5 | 211.2 / 231.9 / 229.8 | 12.62 | 21.21 | 23.26 |
...
| CHLORO | 평균 12.43 · 최대 21.43 | 평균 12.38 · 최대 21.43 | 평균 12.16 · 최대 22.25 |
...
| CHLORO | 197.7 / 217.1 / 207.1 | 204.4 / 227.7 / 225.9 |
...
| CHLORO | HELD | -0.04 1.58 1.93 1.21 0.25 -1.77 | -0.03 1.55 1.9 1.19 0.28 -1.66 |
| CHLORO | TWOS | -0.26 -0.52 -0.07 | -0.15 -0.35 -0.03 |
