...
export const jelly = {
  ...
  knobs: [
    { group: "SWARM", key: "count", label: "COUNT", min: 1, max: 9, step: 1, value: 9 },
    ...
    { group: "BELL", key: "pulse", label: "PULSE", min: 0, max: 0.35, step: 0.01, value: 0.03 },
    // 한 바퀴에 몇 번 뛰는가. 정수여야 한 바퀴 끝에서 제자리로 돌아온다
    { group: "BELL", key: "throb", label: "THROB", min: 1, max: 4, step: 1, value: 3 },
    { group: "BELL", key: "hand", label: "HAND", min: 0, max: 1, step: 0.05, value: 0.1, hint: "종 윗선이 보름달처럼 손으로 오린 듯 흔들리는 정도. 0이면 반듯한 반원이다" },
    { group: "BELL", key: "hem", label: "HEM", min: 0, max: 1, step: 0.05, value: 0.45, hint: "종 밑단 띠의 진하기. 가리비를 따라 종과 같은 통으로 한 번 더 찍는다. 0이면 띠 없이 가리비 모양만 남는다" },
    ...
    { group: "WHISKERS", key: "tentacles", label: "TENTACLES", min: 0, max: 20, step: 1, value: 11, hint: "수염의 수. 밑단 가장자리에서 늘어지는 가는 촉수다" },
    { group: "WHISKERS", key: "trail", label: "TRAIL", min: 0.1, max: 0.7, step: 0.01, value: 0.14, hint: "수염의 길이. 판 높이에 대한 비율이다" },
    ...
    { group: "LEGS", key: "reach", label: "REACH", min: 1, max: 10, step: 0.1, value: 3, hint: "다리의 길이. 종 크기의 몇 배인가 — BELL을 키우면 다리도 길어진다" },
    { group: "LEGS", key: "girth", label: "GIRTH", min: 0.5, max: 3, step: 0.1, value: 1.7, hint: "다리의 굵기. 종 크기를 따라 함께 굵어진다" },
    { group: "LEGS", key: "swing", label: "SWING", min: 0, max: 1, step: 0.05, value: 1, hint: "다리가 흐느적거리는 몫. 낮을수록 제 자세를 지킨 채 천천히 흔들리고, 1이면 파동이 다리를 통째로 훑는다" },
    { group: "WATER", key: "deep", label: "DEEP", min: 0.2, max: 1, step: 0.05, value: 1 },
